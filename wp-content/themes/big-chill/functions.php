<?php
/**
 * Big Chill functions and definitions
 *
...
if ( ! defined( 'BIG_CHILL_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	$theme_data = wp_get_theme();
	define( 'BIG_CHILL_VERSION', $theme_data->get( 'Version' ) );
}
...
if ( ! function_exists( 'big_bob_setup' ) ) :
	...
	function big_bob_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Navbar', 'big-chill' ),
				'menu-2' => esc_html__( 'Main Sidebar', 'big-chill' ),
				'menu-3' => esc_html__( 'Footer', 'big-chill' ),
				'menu-4' => esc_html__( 'Page Sidebar', 'big-chill' ),
			)
		);
...
function big_bob_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Main Sidebar 1', 'big-chill' ),
			'id'            => 'sidebar-1',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Main Sidebar 2', 'big-chill' ),
			'id'            => 'sidebar-2',
			...
			This will be set below the first sidebar.', 'big-chill' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Page Sidebar 1', 'big-chill' ),
			'id'            => 'sidebar-3',
			...
			If a main sidebar menu is used, then the widgets (blocks) for this area will be featured below it.', 'big-chill' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Page Sidebar 2', 'big-chill' ),
			'id'            => 'sidebar-4',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer', 'big-chill' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'These widgets (blocks) will be entered into the footer at the bottom of the page.', 'big-chill' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
function big_bob_scripts() {
	wp_enqueue_style( 'big-chill-style', get_stylesheet_uri(), array(), BIG_CHILL_VERSION );
	wp_style_add_data( 'big-chill-style', 'rtl', 'replace' );
    $big_bob_prev_font_1 = "";
    $big_bob_prev_font_2 = "";
    $big_bob_prev_font_3 = "";
    if (get_theme_mod('big_bob_fonts_title', 'Oxygen') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_title', 'Oxygen');
        ...
        wp_enqueue_style('big-chill-google-fonts', esc_url($big_bob_url), false);
        $big_bob_prev_font_1 = $big_bob_url;
    }
	if (get_theme_mod('big_bob_fonts_main_title', 'Kolker Brush') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_main_title', 'Kolker Brush');
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if ($big_bob_url != $big_bob_prev_font_1) {
            wp_enqueue_style('big-chill-google-fonts-2', esc_url($big_bob_url), false);
        }
		$big_bob_prev_font_2 = $big_bob_url;
    }
    if (get_theme_mod('big_bob_fonts_paragraph', "Oxygen") != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_paragraph', "Oxygen");
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if (($big_bob_url != $big_bob_prev_font_1) && ($big_bob_url != $big_bob_prev_font_2)) {
            wp_enqueue_style('big-chill-google-fonts-3', esc_url($big_bob_url), false);
        }
		$big_bob_prev_font_3 = $big_bob_url;
    }
    if (get_theme_mod('big_bob_fonts_misc', 'Oxygen') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_misc', 'Oxygen');
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if (($big_bob_url != $big_bob_prev_font_1) && ($big_bob_url != $big_bob_prev_font_2) && ($big_bob_url != $big_bob_prev_font_3)) {
            wp_enqueue_style('big-chill-google-fonts-4', esc_url($big_bob_url), false);
        }
    }
	wp_enqueue_style('big-bob-font-awesome', get_template_directory_uri() . '/vendor/fontawesome-free/css/all.min.css');
	wp_enqueue_script( 'big-bob-scripts-js', get_template_directory_uri() . '/js/big-chill-scripts.js?v=0.1', array('jquery'), '20160909', true );

	wp_enqueue_script( 'big-bob-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), BIG_CHILL_VERSION, true );
...
function big_bob_guten_enqueue() {
    wp_enqueue_script(
        ...
        get_template_directory_uri() . '/js/big-chill-guten.js?v=0.1',
		array( 'wp-blocks' )
    );
}
...
function big_bob_register_my_pattern_categories() {
	register_block_pattern_category(
		...
		array( 'label' => __( 'Cover', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-nav-color-patterns',
		array( 'label' => __( 'Navbar Colors', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-body-color-patterns',
		array( 'label' => __( 'Body Colors', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-mixed-color-patterns',
		array( 'label' => __( 'Mixed Colors', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-footer-patterns',
		array( 'label' => __( 'Footer', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-images-text-patterns',
		array( 'label' => __( 'Images and Text', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-text-patterns',
		array( 'label' => __( 'Text', 'big-chill' ) )
	);
	register_block_pattern_category(
		'big_bob-post-patterns',
		array( 'label' => __( 'Blog', 'big-chill' ) )
	);
}
...
function big_bob_register_my_patterns() {
	register_block_pattern(
		'big-chill/title-description-image-list-nav-colors',
		array(
			'title'      => __( 'Tile, Description, Image, and List in Nav Colors', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/four-images-with-text-nav-colors',
		array(
			'title'      => __( 'Four Images with Navbar Colors', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/four-images-with-text-body-colors',
		array(
			'title'      => __( 'Four Images with Body Colors', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/image-collage-with-text-body-colors',
		array(
			'title'      => __( 'Image Collage with Body Colors', 'big-chill' ),
			'categories' => array( 'big_bob-body-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/image-collage-with-text-nav-colors',
		array(
			'title'      => __( 'Image Collage with Nav Colors', 'big-chill' ),
			'categories' => array( 'big_bob-nav-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/forest-cover',
		array(
			'title'      => __( 'Large Cover Block', 'big-chill' ),
			...
			<h2 class="alignwide has-text-align-left has-text-color" style="color:#ffe074;font-size:64px">Welcome to Big Chill</h2>
			<!-- /wp:heading -->
	...
	register_block_pattern(
		'big-chill/fuji-cover',
		array(
			'title'      => __( 'Cover Block with Images', 'big-chill' ),
			'categories' => array( 'big_bob-cover-patterns' ),
	...
	register_block_pattern(
		'big-chill/slant-call-to-action',
		array(
			'title'      => __( 'Slanted Call to Action', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/double-call-to-action',
		array(
			'title'      => __( 'Double Call to Action', 'big-chill' ),
			'categories' => array( 'big_bob-mixed-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/three-column-footer',
		array(
			'title'      => __( 'Three Column Footer', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/high-low-images-text',
		array(
			'title'      => __( 'High Low Imgages', 'big-chill' ),
			'categories' => array( 'big_bob-images-text-patterns' ),
	...
	register_block_pattern(
		'big-chill/image-angled-overlay-text',
		array(
			'title'      => __( 'Image with Angled Overlay and Text', 'big-chill' ),
			'categories' => array( 'big_bob-nav-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/images-nav-colored-strip',
		array(
			'title'      => __( 'Images and Nav Colored Strip', 'big-chill' ),
			'categories' => array( 'big_bob-mixed-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/restaurant-menu',
		array(
			'title'      => __( 'Restaurant Menu)', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/simple-call-to-action',
		array(
			'title'      => __( 'Simple Call to Action', 'big-chill' ),
			'categories' => array( 'big_bob-body-color-patterns' ),
	...
	register_block_pattern(
		'big-chill/full-featured-image-with-paragraph',
		array(
			'title'      => __( 'Full Featured Image', 'big-chill' ),
	...
	register_block_pattern(
		'big-chill/fit-featured-image-with-paragraph',
		array(
			'title'      => __( 'Fit Featured Image', 'big-chill' ),
			'categories' => array( 'big_bob-post-patterns' ),
			'content'    => '<!-- wp:post-featured-image {"className":"is-style-bb-block-fi-full"} /-->
