...
function big_bob_customize_register( $wp_customize ) {
    ...
    $bb_widgets_section->title = __( 'Sidebar and Footer Blocks', 'big-chill' );
    $wp_customize->get_setting( 'header_textcolor' )->transport = 'refresh';
    $wp_customize->get_control('header_textcolor')->description = __('This controls the color of the title (not the logo).', "big-chill");
    $wp_customize->get_control('header_textcolor')->priority = -1;
    $wp_customize->get_control('header_textcolor')->label = __('Title Color', 'big-chill');
    $wp_customize->get_section( 'header_image' )->title = __('Homepage Header Media', 'big-chill');
    $wp_customize->get_section( 'header_image' )->priority = '150';
    $wp_customize->get_setting( 'header_image' )->transport = 'refresh';
    $wp_customize->get_section( 'header_image' )->description = __("The big-chill theme is designed to maximize the size of any header image 
    ...
    then you can make the changes in the <u>Layout</u> section.', "big-chill");
    ...
    Turning this off usually looks best when <u>Center Navbar</u> has been switched on.', "big-chill");
    ...
    setting.  White or a light color works best when the theme is in bright mode.', "big-chill");
    ...
    <u>Header Media Options</u>section to OFF.", "big-chill");
    $wp_customize->get_control( 'external_header_video' )->label = __("Use a YouTube URL", "big-chill");
    ...
    'label' => __('Preloader for Featured and Header Media', 'big-chill'),
    'section' => 'title_tagline',
    'settings' => 'big_bob_preloader',
    'type' => 'radio',
    'choices' => array(
      'On' => __('On', 'big-chill'),
      'Off' => __('Off', 'big-chill'),
	),
    'priority' => 0,
    'description' => __('This turns the prelaoder on and off when featured and header media needs to be loaded.', 'big-chill'),
    ));

    $wp_customize->add_setting('big_bob_extra_large_title', array(
        'default'     => 'On',
        'transport'   => 'refresh',
        'sanitize_callback' => 'big_bob_checkMediaFit',
    ));

    $wp_customize->add_control('big_bob_extra_large_title', array(
        'label' => __('Extra Large Title in Navbar', 'big-chill'),
        'section' => 'big_bob_navigation',
        'settings' => 'big_bob_extra_large_title',
        'type' => 'radio',
        'choices' => array(
            'On' => __('On', 'big-chill'),
            'Off' => __('Off', 'big-chill'),
        ...
        'priority' => 50,
        'description' => __("This will make the font size of the title in the navbar extra large.
        This will not affect the logo size.", 'big-chill'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_extra_large_title', array(
    ...
    'label' => __('Title Below Nav', 'big-chill'),
    'section' => 'big_bob_navigation',
    'settings' => 'big_bob_title_below_nav',
    'type' => 'radio',
    'choices' => array(
        'Extra Big' => __('Extra Big', 'big-chill'),
        'Big' => __('Big', 'big-chill'),
        'Small' => __('Small', 'big-chill'),
        'Logo Below Nav' => __('Logo Below Nav', 'big-chill'),
        'Big Tagline Only' => __('Big Tagline Only', 'big-chill'),
        'Small Tagline Only' => __('Small Tagline Only', 'big-chill'),
        'Off' => __('Off', 'big-chill'),
	),
    'priority' => 50,
    'description' => __('This removes the title and tagline from the navbar, and
    sets the title and tagline below the navbar on the homepage.  If you turn on this feature, 
    then you may want to turn on the <u>Center Navbar</u> control below.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_foreground_color_NF', array(
        'label'        => __('Navbar and Footer Foreground Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_foreground_color_NF',
        'priority' => -5,
        'description'   => __('This will change the color behind the text in the navbar and footer.', 'big-chill'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_color_NF', array(
        'label'        => __('Navbar and Footer Link Color', 'big-chill'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_hover_color_NF', array(
        'label'        => __('Navbar and Footer Link Hover Color', 'big-chill'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_text_color_NF', array(
        'label'        => __('Navbar and Footer Text and Border Color', 'big-chill'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_foreground_color', array(
        'label'        => __('Body and Sidebar Foreground Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_foreground_color',
        'priority' => -5,
        'description'   => __('This will change the color behind the text in the body and sidebar.', 'big-chill'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_background_color', array(
        'label'        => __('Background Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_background_color',
        'priority' => -5,
        'description'   => __('This will change the color behind everything.', 'big-chill'),
	)));
    ...
    $wp_customize->add_control( 'big_bob_menu_button_icon_color', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Menu Icon Darkness', 'big-chill' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        for the menu button in the navbar for small screens.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_home_nav_ti', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Home Navbar and Footer Opacity', 'big-chill' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
    ...
    $wp_customize->add_control( 'big_bob_range_nav_ti', array(
        ...
        'priority' => 10,
        'section' => 'colors',
        'label' => __( 'Navbar and Footer Opacity', 'big-chill' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for foreground color at the top of the page
        for the rest of your pages.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_sn', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Scrolled Navbar Opacity', 'big-chill' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for the navbar after it has scrolled down the screen.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_sb', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Body Opacity', 'big-chill' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for foreground color for the body, sidebar, and footer.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_tile_large_screen', array(
        ...
        'label' => __( 'Space from Top for Tiled Page Body on Large Screens', 'big-chill' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_tile_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Tiled Page Body on Tablets', 'big-chill' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
        ...
        on tablet sized screens.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_tile_phone', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Tiled Page Body on Phones', 'big-chill' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
        ...
        'description'   => __('This sets the distance between the body of a tiled page (post style) and the top of the page
        on phone sized screens.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_wide_large_screen', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( "Space from Top for Big Page Body on Large Screens", 'big-chill' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_wide_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Big Page Body on Tablets', 'big-chill' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_wide_phone', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Big Page Body on Phones', 'big-chill' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    'type' => 'radio',
    'choices' => array(
        'Shadow' => __('Shadow', 'big-chill'),
        'Link Color Backlight' => __('Link Color Backlight', 'big-chill'),
        'Off' => __('Off', 'big-chill'),
    ),
    'priority' => 0,
    ...
    behind the hamburger menu site title.', 'big-chill'),
    ));
    ...
    The borders will be added around the body, sidebar, and footer.', 'big-chill'),
    ));
    ...
    There is no shadow effect available if a logo is displayed.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_color', array(
        'label'        => __('Body Link Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_link_color',
        'priority' => -1,
        'description'   => __('This  will change the color of all the body links.', 'big-chill'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_hover_color', array(
        'label'        => __('Body Link Hover Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_link_hover_color',
        'priority' => -1,
        'description'   => __('This  will change the hover color of all the body links.', 'big-chill'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_menu_background_color', array(
        'label'        => __('Menu Button Background Color', 'big-chill'),
        'section'    => 'colors',
		'settings'   => 'big_bob_menu_background_color',
        'priority' => -1,
        'description'   => __('This  will change the background color of all the menu button.', 'big-chill'),
	)));
    ...
    'label' => __('Set Header Media to Background', 'big-chill'),
    ...
    'priority' => 0,
    'description' => __('Turning this on will cause the header media to stay in place and the text to scroll over the top of the media.', 'big-chill'),
	));
    ...
    'label' => __('Show Header Video On Mobile', 'big-chill'),
    'section' => 'header_image',
    ...
    The item loaded (image or video) is based on the width when the site loads.', 'big-chill'),
    ));
    ...
    'priority' => 0,
    'description' => __('Fills the header image across the entire screen.', 'big-chill'),
    ));
    ...
    on the window size, some of the image may be cut off.', 'big-chill'),
    ));
    ...
    when the <u>Title Below Nav</u> contorl in the Navigation section is switched off.', 'big-chill'),
    ));
    ...
    'priority' => 0,
    'description' => __('This places the bacground image over the background video.', 'big-chill'),
    ));
    ...
    'label' => __('Sticky Sidebar', 'big-chill'),
    'section' => 'big_bob_navigation',
    ...
    and become its own window with its own scrollbar, 
    and it will stick into position when you scroll down the screen.', 'big-chill'),
    ));
    ...
    'label' => __('Sticky Title On Mobile', 'big-chill'),
    'section' => 'big_bob_navigation',
    ...
    dsiplayed regarless of the status of this control.', 'big-chill'),
    ));

    $wp_customize->add_section('big_bob_body_style', array(
        'title'      => __('Layout', 'big-chill'),
        'priority'   => 30,
    ));
    ...
    'label' => __('Header Space for Featured Media', 'big-chill'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_highlight_feature_image',
    'type' => 'radio',
    'choices' => array(
        'On' => __('On', 'big-chill'),
        'Featured Images Only' => __('Featured Images Only', 'big-chill'),
        'Off' => __('Off', 'big-chill'),
	),
    'priority' => 10,
    ...
    it is best to leave it in the <u>Featured Images Only</u> position.", 'big-chill'),
    ));
    ...
    'label' => __('Page Titles', 'big-chill'),
    'section' => 'big_bob_body_style',
    ...
    best to reset both controls to <u>Featured Images Only</u>.", 'big-chill'),
    ));
    ...
    'label' => __('Excerpt Mode', 'big-chill'),
    'section' => 'big_bob_body_style',
    ...
    for the search results page.", 'big-chill'),
    ));
    ...
    'label' => __('Post Page Featured Image', 'big-chill'),
    'section' => 'big_bob_body_style',
    ...
    'priority' => 0,
    'description' => __("This will show your featured images on your posts and archive pages.", 'big-chill'),
    ));
    ...
    'label' => __('Rounded Corners', 'big-chill'),
    'section' => 'big_bob_body_style',
    ...
    'priority' => -1,
    'description' => __("This will create rounded corners for groups, images, and some other blocks.", 'big-chill'),
    ));
    ...
    'label' => __('No Sidebar for Static Pages', 'big-chill'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_blog_sidebar_only',
    'type' => 'radio',
    'choices' => array(
        'Home Only' => __('Home Only', 'big-chill'),
        'Except Home' => __('Except Home', 'big-chill'),
        'Off' => __('Off', 'big-chill'),
	),
    'priority' => -1,
    ...
    you choose <u>Home Only</u> or <u>Except Home</u>, your homepage must be defined as a static page in <u>Homepage Settings</u>.", 'big-chill'),
    ));

    $wp_customize->add_section('big_bob_background_video', array(
        'title' => __('Background Media', 'big-chill'),
        'priority'   => 90,
        'description'  => __('You can use this section to set mobile friendly background images and videos
        into different areas of your site, inlcluding area not covered by header media and featured media.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'big_bob_background_image_media', array(
        ...
        'label' => __('Load a Background Image.', 'big-chill'),
        'mime_type' => 'image',
        'priority' => -1,
        ...
        pages set as <i>Big Pages</i> in the <u>Layout</u> section.', 'big-chill'),
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'big_bob_background_video_media', array(
        ...
        'label' => __('Load a Background Video.', 'big-chill'),
        'mime_type' => 'video',
        'priority' => 0,
    ...
    'label' => __('Show Footer', 'big-chill'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_show_footer',
    'type' => 'radio',
    'choices' => array(
        'On' => __('On', 'big-chill'),
        'Remove Attribution Only' => __('Remove Attribution Only', 'big-chill'),
        'Off' => __('Off', 'big-chill'),
	),
    'priority' => 100,
    'description' => __("Turning this off will completely remove the footer and the back to top button.", 'big-chill'),
    ));
	...
	$wp_customize->add_section( 'big_bob_fonts' , array(
        ...
        Because the Google fonts library is so large, you will
        find that some fonts are more compatible than others.  If you delete all of the 
        font names then your fonts will be set to default and will be hosted locally.", 'big-chill'),
	) );
    // Add settings
	$wp_customize->add_setting( 'big_bob_fonts_main_title', array(
        'default'           => __( 'Kolker Brush', 'big-chill' ),
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_main_title',
           array(
               'label'    => __( 'Title', 'big-chill' ),
               'section'  => 'big_bob_fonts',
               'settings' => 'big_bob_fonts_main_title',
               'type'     => 'text',
               'description' => __("You can adjust the size of the title in the <u>Navigation</u> section.
               If this is left blank, then the <b>headings</b> font will be used as the title font.", 'big-chill'),
               'priority' => 0,
           )
       )
   );
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_paragraph',
           array(
               'label'    => __( 'Paragraph and Miscellaneous', 'big-chill' ),
               'section'  => 'big_bob_fonts',
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_misc',
           array(
               'label'    => __( 'Main Menus', 'big-chill' ),
               'section'  => 'big_bob_fonts',
               'settings' => 'big_bob_fonts_misc',
               'type'     => 'text',
               'description' => __("You can adjust the menu size and position
               in the <u>Navigation</u> section.", 'big-chill'),
               'priority' => 0,
           )
       )
   );
   ...
   $wp_customize->add_setting('big_bob_center_nav', array(
    ...
    'label' => __('Center Navbar', 'big-chill'),
    'section' => 'big_bob_navigation',
    ...
    'label' => __('Menu Size', 'big-chill'),
    'section' => 'big_bob_navigation',
    'settings' => 'big_bob_menu_size',
    'type' => 'radio',
    'choices' => array(
        'Small' => __('Small', 'big-chill'),
        'Medium' => __('Medium', 'big-chill'),
        'Large' => __('Large', 'big-chill'),
    ),
    'priority' => 100,
    ...
    $wp_customize->add_control( 'big_bob_uncentered_menu_from_top', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Right Aligned Menu Items from Top', 'big-chill' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => -20,
        ...
        when it is not centered and on a wide screen.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_scrolled_uncentered_menu_from_top', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Scrolled Right Aligned Menu Items from Top', 'big-chill' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 20,
        ...
        'description'   => __('This control determines how far the menu items in the navbar is from the top
        when it is not centered and on a wide screen after it has scrolled down the screen.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_menu_button_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Menu Button from Top in Tablet', 'big-chill' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
        ...
        This is used regardles of whether or not the menu items are centered.', 'big-chill'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_scrolled_menu_button_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Scrolled Menu Button from Top in Tablet', 'big-chill' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
    ...
    $wp_customize->add_control( 'big_bob_menu_button_phone', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Menu Button from Top in Phones', 'big-chill' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
    ...
    'label' => __('Menu Spacing', 'big-chill'),
    'section' => 'big_bob_navigation',
    ...
    'priority' => 100,
    'description' => __("This will change the spacing between your menu items.", 'big-chill'),
    ));
    ...
    'label' => __('Underline Current Page', 'big-chill'),
    'section' => 'big_bob_navigation',
    ...
    It may be helpful to turn this off if you are creating a one page website.", 'big-chill'),
    ));
    ...
    'label' => __('Add Tagline When Title is in Navbar', 'big-chill'),
    'section' => 'big_bob_navigation',
...
{
        $bb_link = get_theme_mod('big_bob_link_color', '#b797ed');
        $bb_link = str_replace("#", "", $bb_link);
        $bb_link_hover = get_theme_mod('big_bob_link_hover_color', '#5d0ced');
        $bb_link_hover = str_replace("#", "", $bb_link_hover);
        $bb_menu_background = get_theme_mod('big_bob_menu_background_color', '#000000');
...
function big_bob_set_nav() {
    ...
    $BBMBT = get_theme_mod('big_bob_menu_button_tablet', '38');
    ...
    if (get_theme_mod('big_bob_center_nav', "On") == "On") {
        if (get_theme_mod( 'big_bob_extra_large_title', 'On' ) == 'On') {
            ?>
            <style type="text/css">
        ...
        $UMFT = get_theme_mod('big_bob_uncentered_menu_from_top', '5');
        $SUMFT = get_theme_mod('big_bob_scrolled_uncentered_menu_from_top', '39');
        if (get_theme_mod( 'big_bob_extra_large_title', 'On' ) == 'On') {
            ?>
            <style type="text/css">
                .bb-site-title-top {
...
function big_bob_change_fonts_title() {
    if (get_theme_mod('big_bob_fonts_title', 'Oxygen') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_title', 'Oxygen'); ?>
			<style type="text/css">
...
function big_bob_change_fonts_main_title() {
    if (get_theme_mod('big_bob_fonts_main_title', 'Kolker Brush') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_main_title', 'Kolker Brush'); ?>
			<style type="text/css">
...
function big_bob_change_fonts_paragraph() {
    if (get_theme_mod('big_bob_fonts_paragraph', "Oxygen") != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_paragraph', "Oxygen"); ?>
			<style type="text/css">
                body,
...
function big_bob_change_fonts_misc() {
    if (get_theme_mod('big_bob_fonts_misc', 'Oxygen') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_misc', 'Oxygen'); ?>
			<style type="text/css">
                #primary-menu li,
                #bb-sidebar-menu li {
...
function big_bob_add_bright() {
        ...
        $FCNF = get_theme_mod('big_bob_foreground_color_NF', '#5d0ced');
        ...
        $BBBC = get_theme_mod('big_bob_background_color', '#141414');
...
function big_bob_add_shadow() {
    if( get_theme_mod( 'big_bob_background_shadow', 'Shadow' ) == 'Shadow' ) {
		?>
			<style type="text/css">
                .bb-site-title-top {
		...
		<?php
    } else if ( get_theme_mod( 'big_bob_background_shadow', 'Shadow' ) == 'Link Color Backlight' ) {
        $bb_link = get_theme_mod('big_bob_link_color', '#b797ed');
        $bb_link = str_replace("#", "", $bb_link);
		?>
			<style type="text/css">
...
function big_bob_turn_on_big_description() {
    ...
    <?php
     ...
     if (get_theme_mod( 'big_bob_title_below_nav', 'Off' ) == 'Extra Big') {
        ?>
        <style type="text/css">
            .site-title {
                font-size: 70px;
...
function big_bob_media_in_background() {
    if( get_theme_mod( 'big_bob_media_to_background', 'On' ) == 'On' ) {
		?>
            <style type="text/css">
